/*
*
* drivers/media/tdmb/isdbt_port_mtv222.h
*
* isdbt driver
*
...
#ifndef __ISDBT_PORT_MTV222_H__
#define __ISDBT_PORT_MTV222_H__
...
#endif /* #if defined(CONFIG_MTV_SPI) */
...
extern struct MTV222_CB *mtv222_cb_ptr;
...
#define DMB_LEVEL_INTR_INC	mtv222_cb_ptr->level_intr_cnt++;
#define DMB_INV_INTR_INC	mtv222_cb_ptr->invalid_intr_cnt++;
#define DMB_OVF_INTR_INC	mtv222_cb_ptr->ovf_intr_cnt++;
#define DMB_UNF_INTR_INC	mtv222_cb_ptr->udf_intr_cnt++;
...
#define DMB_UNF_INTR_INC	do {} while (0)
	...
	do {	\
		...
		mtv222_cb_ptr->ovf_intr_cnt, mtv222_cb_ptr->udf_intr_cnt,\
		mtv222_cb_ptr->invalid_intr_cnt, mtv222_cb_ptr->level_intr_cnt,\
